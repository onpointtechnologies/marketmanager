...
# Generation Time: 2018-10-26 06:56:49 +0000
# ************************************************************
...
INSERT INTO `checkout` (`id`, `business_name`, `checkout_date`, `sellers_fee`, `ebt_tokens`, `ebt_match`, `atm_tokens`, `mm_tokens`, `mm_vouchers`, `piersons_amount`, `comment`, `fmnp_fvc`, `open_door`, `vendor_type`, `market_id`, `flat_fee`, `percentage_fee`, `custom_fee`, `created_at`, `total_owed`, `checkout_market_name`, `total_sales`, `week`, `public_id`, `authenticated_user`)
VALUES
...
INSERT INTO `vendors` (`id`, `users_id`, `vendor_name`, `business_name`, `address`, `vendor_city`, `vendor_state`, `vendor_phone`, `vendor_email`, `certificate_expiration`, `certificate_number`, `issuing_county`, `vendor_type`, `products_sold`, `website`, `facebook`, `instagram`)
VALUES
