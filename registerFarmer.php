...
if (isset($_POST["submit"])){
  ...
  if (mysqli_num_rows($sql)>0){
    ...
    $query = mysqli_query($conn,"INSERT INTO users (position,password,name,email,phoneNumber,address,location,gender,DoB,cropType,picture) VALUES ('Farmer','$password','$name','$email','$phoneNumber','$address','$location','$gender','$DoB','$cropType','$filepath')");
  ...
  <div class="container">
    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-sm-4">
          <h4 class="fancy">Sign Up as Farmer</h4>
    			<hr class="mt-0">
          <?php
              //echo $alert;
          ?>
          <form action="" method="post">
            ...
            <div class="form-group">
              <input name="cropType" placeholder="Type of crop you plant" type="text" class="form-control" required="">
            </div>
             <div class="form-group">
